...
```
NID = first 4 bytes of SHA-1(function_name + suffix), interpreted as little-endian uint32
```

### Default Suffix

The standard NID suffix is a 16-byte sequence:
...
4. **Interpret** as a little-endian 32-bit unsigned integer
