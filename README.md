...
One of the flagship projects built with **ps3recomp** is the native recompilation of **Uncharted 3: Drake's Deception**.

The goal is to transform the original PlayStation 3 executable into a **native PC application** without runtime emulation. This project validates the ps3recomp framework on one of the most technically demanding PS3 games.

## Current Progress

- ✅ Native PPU recompilation
- ✅ SPU runtime integration
- ✅ Game initialization sequence
- ✅ Runtime, threading and memory systems
- ✅ Archive and file loading
- ✅ Audio and SPURS initialization
- ✅ RSX command generation
- 🔄 Graphics backend in active development
...
- Performance optimization and unlocked framerate
- Modern multiplayer networking layer

## Vision

The long-term objective is to preserve Uncharted 3 as a native desktop application and demonstrate the capabilities of static recompilation for PlayStation 3 software.
