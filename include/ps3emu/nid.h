 ...
 *
 * Most firmware libraries use the standard 16-byte suffix declared below;
 * some use a library-specific salt. In practice the NID database is
 * precomputed and shipped as a lookup table.
 */
